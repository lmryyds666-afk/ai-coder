...
import com.lmr.aicoder.annotation.AuthCheck;
import com.lmr.aicoder.common.BaseResponse;
import com.lmr.aicoder.common.DeleteRequest;
...
import com.lmr.aicoder.model.dto.app.*;
...
import com.lmr.aicoder.service.ProjectDownloadService;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request){
        Long appId = appService.createApp(appAddRequest, userService.getLoginUser(request));
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request){
        ...
        //判断该ID的应用是否存在
        App byIdApp = appService.getById(appUpdateRequest.getId());
        ThrowUtils.throwIf(byIdApp == null,ErrorCode.NOT_FOUND_ERROR);
        //仅允许用户更改自己的 应用
        if(!byIdApp.getUserId().equals(loginUser.getId())){
